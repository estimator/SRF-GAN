...
__all__ = ["build_resnet_pafpn_backbone", "build_retinanet_resnet_pafpn_backbone", "build_fcos_resnet_pafpn_backbone", "PAFPN"]


class PAFPN(Backbone):
    """
...
@BACKBONE_REGISTRY.register()
def build_retinanet_resnet_pafpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
