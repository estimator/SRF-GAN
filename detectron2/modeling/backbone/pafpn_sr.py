...
# Reference paper : Path Aggregation Network for instance segmentation, Liu et al., CVPR18
...
from detectron2.modeling.super_resolution import generator_rdb as G_rdb

__all__ = ["build_resnet_pafpn_sr_backbone", "build_retinanet_resnet_pafpn_sr_backbone", "PAFPN_SR", "build_fcos_resnet_pafpn_sr_backbone"]


class PAFPN_SR(Backbone):
    """
    ...
    def __init__(
        ...
        for idx, in_channels in enumerate(in_channels):
            ...
            if idx>0:
                ...
                # downsample_norm = get_norm("BN", out_channels)
...
@BACKBONE_REGISTRY.register()
def build_retinanet_resnet_pafpn_sr_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
...
@BACKBONE_REGISTRY.register()
def build_fcos_resnet_pafpn_sr_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
