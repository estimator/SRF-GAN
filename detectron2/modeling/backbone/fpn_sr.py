...
__all__ = ["build_resnet_fpn_sr_backbone", "FPN_SR", "build_retinanet_resnet_fpn_sr_backbone", "build_fcos_resnet_fpn_sr_backbone"]

class FPN_SR(Backbone):
    """
...
@BACKBONE_REGISTRY.register()
def build_retinanet_resnet_fpn_sr_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
...
@BACKBONE_REGISTRY.register()
def build_fcos_resnet_fpn_sr_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
